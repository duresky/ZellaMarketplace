...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(91, 33, 153, 1);
  static const Color accent_color_shadow =
      Color.fromRGBO(229, 65, 28, .40); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(39, 6, 64, 1);
  static Color splash_screen_color = Color.fromRGBO(
      59, 12, 128, 1); // if not sure , use the same color as accent color
  ...
  static Color golden = Color.fromRGBO(139, 148, 103, 1);
  ...
  //------------
  static const Color blue_chill = Color.fromRGBO(59, 12, 128, 1);
  static const Color cruise = Color.fromRGBO(124, 196, 195, 1);
  //---------------
  static const Color brick_red = Color.fromRGBO(59, 12, 128, 1);
  static const Color cinnabar = Color.fromRGBO(34, 10, 74, 1);
